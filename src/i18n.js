...
const resources = {
  en: {
    translation: {
      ...
      "sign_up_successful": "Sign up successful! Welcome to ML Model Management.",
  ...
  tr: {
    translation: {
      ...
      "delete":"Sil",
      "model_deleted_successfully": "Model başarıyla silindi",
      "error_deleting_model": "Model silinirken hata oluştu",
      "file_deleted_successfully": "Dosya başarıyla silindi",
      "error_deleting_file": "Dosya silinirken hata oluştu", 
      "loading": "Yükleniyor...",
      "model_name_cannot_be_empty": "Model adı boş olamaz",
      "sending_model_data": "Model verisi gönderiliyor",
      "api_response": "API Yanıtı",
      "error_creating_model": "Model oluşturulurken hata oluştu",
      "failed_to_create_model": "Model oluşturulamadı",
      "sign_in": "Giriş Yap",
      "sign_up": "Kayıt Ol",
      "sign_out": "Çıkış Yap",
      "email": "E-posta",
      ...
      "sign_up_successful": "Kayıt başarılı! ML Model Yönetimine hoş geldiniz.",
